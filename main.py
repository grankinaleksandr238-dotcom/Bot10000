...
# ==================== ФУНКЦИИ АВТОУДАЛЕНИЯ (ДОБАВЛЕНЫ) ====================
...
async def init_db():
    async with db_pool.acquire() as conn:
        ...
        # Таблица подтверждённых чатов (добавлено поле auto_delete_enabled)
        await conn.execute('''
...
# ==================== РАБОТА С ПОЛЬЗОВАТЕЛЯМИ (исправлено) ====================
...
# ==================== ФУНКЦИИ ДЛЯ БОССОВ (исправлен порядок) ====================
BOSS_ANGRY_PHRASES = [
...
async def cmd_boss_status(message: types.Message):
    ...
    # Прогресс-бар HP (исправлено: показываем оставшееся здоровье)
    bar_length = 10
...
# ==================== УПРАВЛЕНИЕ МАГАЗИНОМ (исправлено: кнопка "Управление магазином") ====================
