...
async def auto_delete_message(message: types.Message, delete_seconds: int = None):
    """Автоматически удаляет исходное сообщение пользователя (команду)."""
    if delete_seconds is None:
        delete_seconds = int(await get_setting("auto_delete_commands_seconds"))
...
async def safe_send_message(user_id: int, text: str, **kwargs):
    # Экранируем HTML, если parse_mode="HTML"
...
BOSS_ANGRY_PHRASES = [
    ...
    "Пфф, слабак! Держи {damage} и не ной!",
]
...
# ==================== ТЕКСТОВЫЕ ФРАЗЫ (с жёсткими выражениями) ====================
BONUS_PHRASES = [
    "🎉 Красава, лови +{bonus} баксов, сука!",
    "💰 Зашкварно богатенький стал! +{bonus}",
    "🌟 Хайпанули? +{bonus} баксов в карман!",
    "🍀 Удача крашеная, держи +{bonus}!",
    "🎁 Ты в тренде, +{bonus} баксов!"
]

CASINO_WIN_PHRASES = [
    "🎰 Краш! Ты выиграл {win} баксов (чистыми {profit}), сука!",
    "🍒 Хайповая комбинация! +{profit} баксов, ёбаный в рот!",
    "💫 Фортуна крашеная, твой выигрыш: {win} баксов!",
    "🎲 Изи-катка, {profit} баксов твои, гандон!",
    "✨ Ты красавчик, обыграл казино! +{profit} баксов!"
]

CASINO_LOSE_PHRASES = [
    "😢 Обидно, потерял {loss} баксов, лох!",
    "💔 Зашкварно, минус {loss}, мудак!",
    "📉 Не фортануло, -{loss} баксов, черт!",
    "🍂 В следующий раз краш будет твоим, а пока -{loss}, обчистили как лоха!",
    "⚡️ Лузернулся на {loss} баксов, петух!"
]

PURCHASE_PHRASES = [
    "✅ Купил! Админ скоро в личку прилетит.",
    "🛒 Товар твой! Жди админа, бро, бля.",
...
THEFT_CHOICE_PHRASES = [
    ...
    "💢 Кого будем грабить, блядь?",
    "😈 Куда направим бандитские лапы, кому пизда?"
]

THEFT_COOLDOWN_PHRASES = [
    "⏳ Ты ещё не остыл после прошлого налёта. Подожди {minutes} мин, лох.",
    "🕐 Полегче, ковбой! Отдохни {minutes} минут, мудак.",
    "😴 Грабить так часто – плохая примета. Возвращайся через {minutes} мин, ЛОХ."
]

THEFT_NO_MONEY_PHRASES = [
    "😕 У тебя нет баксов даже на подготовку к краже, голодранец!",
    "💸 Сначала заработай, потом грабить будешь, бомж!",
    "💰 Пустой карман – не до криминала, нищеброд."
]

THEFT_SUCCESS_PHRASES = [
    "🔫 Красава! Ты украл {amount} баксов у {target}, сука!",
    "💰 Хайпанул, {amount} баксов у {target} теперь твои, блядь!",
    "🦹‍♂️ Удачная кража! +{amount} от {target}!",
    "😈 Ты краш, {target} даже не понял! +{amount}!"
]

THEFT_FAIL_PHRASES = [
    "😢 Облом, тебя спалили! Ничего не украл, лох.",
    "🚨 Треск, {target} оказался слишком бдительным, мудак!",
    "👮‍♂️ Пришлось сваливать, 0 баксов, гнида.",
    "💔 Не фортануло, {target} слишком крутой, черт."
]

THEFT_DEFENSE_PHRASES = [
    "🛡️ {target} отразил атаку! Ты потерял {penalty} баксов, сука!",
    "💥 Бабах! {target} выставил защиту, и ты лишился {penalty} баксов, блядь!",
    "😱 Засада! Ты напоролся на защиту и потерял {penalty} баксов, ОБОССАЛИ!"
]

THEFT_VICTIM_DEFENSE_PHRASES = [
    "🛡️ Твоя защита сработала! {attacker} ничего не украл и потерял {penalty} баксов, сука!",
    "💪 Ты краш! Отбил атаку {attacker} и получил {penalty} баксов, блядь!",
    "😎 Ха! {attacker} думал поживиться, а сам потерял {penalty} баксов, пидор!"
]

DICE_WIN_PHRASES = [
    "🎲 {dice1} + {dice2} = {total} — Победа! +{profit} баксов, сука!",
    "🎲 Круто! {dice1}+{dice2}={total}, ты выиграл {profit}, блядь!",
    "🎲 Хайп! {total} очков, твой выигрыш: {profit}!"
]

DICE_LOSE_PHRASES = [
    "🎲 {dice1} + {dice2} = {total} — Проигрыш. -{loss} баксов, лох.",
    "🎲 Эх, {total} очков, не повезло. -{loss}, мудак.",
    "🎲 В этот раз не зашло, -{loss} баксов, петух."
]

GUESS_WIN_PHRASES = [
    "🔢 Ты угадал! Было {secret}. Выигрыш: +{profit} баксов и +{rep} репутации, сука!",
    "🔢 Красава! Число {secret}, твой выигрыш {profit} баксов, блядь!",
    "🔢 Хайпанул! +{profit} баксов, репутация +{rep}, заебал!"
]

GUESS_LOSE_PHRASES = [
    "🔢 Не угадал. Было {secret}. -{loss} баксов, лох.",
    "🔢 Увы, загадано {secret}. Теряешь {loss} баксов.",
    "🔢 Не фортануло, правильный ответ {secret}. -{loss}."
]

CHAT_WIN_PHRASES = [
    "🔥 {name} только что выиграл {amount} баксов в казино, сука!",
    "💰 Удача на стороне {name}: +{amount} баксов, блядь!",
    "🎰 {name} сорвал куш — {amount} баксов, прибил бы!"
]

CHAT_PURCHASE_PHRASES = [
    "🛒 {name} купил {item} за {price} баксов!",
    "🎁 {name} приобрёл {item}! Админ уже в пути, заебал.",
    "💎 {name} потратил {price} баксов на {item}!"
]

CHAT_GIVEAWAY_PHRASES = [
    "🎁 Не пропусти розыгрыш! Осталось {time}, блядь!",
    "⏰ Напоминание: розыгрыш {prize} заканчивается через {time}, реще!",
    "🔥 Участвуй в розыгрыше {prize}! Осталось {time}, сука!"
]

BOSS_SPAWN_PHRASES = [
    "⚠️ ВНИМАНИЕ! В чате появился {name} (Уровень {level})! Здоровье: {hp}, пизда вам!",
    "👾 Босс {name} пришёл навестить нас! Уровень {level}, HP: {hp}, не сритесь!",
    "🔥 Легендарный {name} пробудился! Уровень {level}, здоровье: {hp}, че каво,нападайте!",
]

# Обновлённые жёсткие фразы для боссов
BOSS_ANGRY_PHRASES = [
    "Ах ты мелкий засранец! Получи {damage} урона, пидор!",
    "Ты думал меня победить, мудак? Ха! Держи {damage} в ответ!",
    "Гррр... больно, сука! Но я ещё жив! Моя атака {damage} по тебе!",
    "Не зли босса, черт! Сейчас получишь {damage}!",
    "Ты всего лишь муравей,уясни это! Моя сила {damage}!",
    "И это всё? А я тебе вмажу на {damage}!",
    "Курица ты, а не воин, блядь! Держи {damage}!",
    "Моя бабушка сильнее бьёт, петух! Но и я могу {damage}!",
    "Ой, щекотно, сука! А теперь {damage} в ответ!",
    "Ты кого трогаешь, попутал? Получай {damage}!",
    "Я тебя сейчас съем,моя котлетка! Сначала {damage} урона!",
    "Пфф, слабак, мудак! Держи {damage} и не ной!",
]

BOSS_HAPPY_PHRASES = [
    "Хе-хе, слабо, лох! Твой урон всего {damage}!",
    "Мощный удар, сука! Но у меня ещё {hp_remaining} HP!",
    "Отличная атака, блядь! Но я не сдамся!",
    "Ой-ой, больно, наебал... Ладно, держи {damage} в ответ!",
    "Ты крут, но пидор, я круче! HP осталось: {hp_remaining}",
    "Удивил кота сосиской! Но у меня ещё {hp_remaining} здоровья!",
    "Неплохо, неплохо, сука... А теперь {damage} по тебе!",
    "Ты заставил меня вспотеть, утопись! Осталось {hp_remaining}!",
    "Хороший удар, блядь! Но я живуч! Осталось {hp_remaining} HP",
    "Почти, петух... но нет! У меня ещё {hp_remaining}!",
    "Больновато, сука... Зато ты получишь {damage}!",
]

BOSS_DEATH_PHRASES = [
    "Я ещё вернусь, суки... проклинаю вас всех!",
    "Невозможно, блядь... я повержен...",
    "Вы победили... забирайте награду...",
    "Аааа, пидоры... моя магия... иссякла...",
    "Ладно, ваша взяла, ток не ссыте! Держите баксы!",
    "Я пал, суки... но это не конец!",
    "Проклятье, блядь! Вы ещё пожалеете!",
    "Ухожу красиво... с деньгами!",
    "Ну всё, я ушёл, петухи, догоняйте!",
    "Вы выиграли этот раунд, суки!",
]

FIGHT_HIT_PHRASES = [
    "💥 Ты нанёс {damage} урона,красава! Заработал {authority} авторитета.",
    "⚡️ Твой удар пришёлся точно в цель, блядь! +{damage} урона, +{authority} авторитета.",
    "🔥 Критический удар, пидор! Ты нанёс {damage} урона и получил {authority} авторитета.",
    "🤜 Хрясь, по ебальничку! Банда получила {damage} урона. Твой авторитет +{authority}.",
    "👊 Смачный удар, ребятки обоссались! {damage} урона, {authority} авторитета.",
]

FIGHT_CRIT_PHRASES = [
    "💢 СОКРУШИТЕЛЬНЫЙ УДАР, сука! Ты нанёс {damage} урона (крит!) и заработал {authority} авторитета.",
    "🌟 Ты в ярости, блядь! Критический урон {damage}, авторитет +{authority}.",
    "⚡️ МОЛНИЕНОСНЫЙ ВЫПАД! {damage} урона, +{authority} авторитета.",
]

FIGHT_MISS_PHRASES = [
    "💨 Ты промахнулся, лох! Банда смеётся над тобой. Авторитет не получен.",
    "😵 Твоя атака не достигла цели. Банда даже не заметила.",
    "🍃 Вжух, петух! Мимо. Попробуй ещё через полчаса.",
]

FIGHT_COUNTER_PHRASES = [
    "😵 Банда контратаковала, сука! Ты потерял {damage} баксов и не получил авторитет.",
    "💥 Ответный удар, блядь! Ты потерял {damage} баксов.",
    "👊 Тебя самого ударили, ебальник на месте?! Минус {damage} баксов.",
]
# ==================== ПОЛНЫЙ РАБОЧИЙ БОТ ====================
...
async def cmd_help(message: types.Message):
    ...
    if not ok:
        await message.answer("❗️ Сначала подпишись на каналы, сука.", reply_markup=subscription_inline(not_subscribed))
        return
    text = (
        ...
        "• 🎰 Казино – испытай удачу, гнида\n"
        "• 🎟 Промокод – активация промокодов\n"
        "• 🏆 Топ игроков – лучшие по баксам, уровню, статам\n"
...
async def cmd_start(message: types.Message):
    ...
    user_id = message.from_user.id
    if await is_banned(user_id) and not await is_admin(user_id):
        await message.answer("⛔ Вы заблокированы, пидор.")
        return
                ...
                async with db_pool.acquire() as conn:
                    ...
                    if referrer_exists and not await is_banned(referrer_id):
                        ...
                        if not existing:
                            ...
                            await safe_send_message(referrer_id, f"🔗 Новый пользователь {message.from_user.first_name} зарегистрировался по вашей ссылке, сука! Награда будет выдана после того, как он совершит 15 успешных ограблений.")
        except:
            pass
    ...
    try:
        ...
        await message.answer("❌ Ошибка базы данных, бля. Попробуй позже.")
        return
    ...
    await message.answer(
        ...
        f"У тебя 1 уровень. Зарабатывай опыт и повышай уровень, пидор!\n\n"
        f"Канал: @lllMALBOROlll (подпишись, бля!)",
...
async def check_sub_callback(callback: types.CallbackQuery):
    if callback.message.chat.type != 'private':
        await callback.answer("Эта функция работает только в личке, сука", show_alert=True)
        return
    if await is_banned(callback.from_user.id) and not await is_admin(callback.from_user.id):
        await callback.answer("⛔ Вы заблокированы, пидор.", show_alert=True)
        return
    ok, not_subscribed = await check_subscription(callback.from_user.id)
    if ok:
        admin_flag = await is_admin(callback.from_user.id)
        await callback.message.edit_text("✅ Подписка подтверждена, лучший! Добро пожаловать.")
        await callback.message.answer("Главное меню:", reply_markup=user_main_keyboard(admin_flag))
    else:
        await callback.answer("❌ Ты ещё не подписался на все каналы, гнида!", show_alert=True)
...
async def no_link(callback: types.CallbackQuery):
    await callback.answer("Ссылка временно недоступна, найди канал вручную, лох", show_alert=True)
...
async def profile_handler(message: types.Message):
    ...
    try:
        ...
        if row:
            ...
            text = "Профиль не найден, бля."
    except Exception as e:
        logging.error(f"Profile error: {e}")
        text = "❌ Ошибка загрузки профиля, сука."
    await message.answer(text, reply_markup=user_main_keyboard(await is_admin(user_id)))
...
async def level_handler(message: types.Message):
    ...
    level_mult = int(await get_setting("level_multiplier"))
    exp_needed = level * level_mult
    bar = progress_bar(exp, exp_needed, 20)
    level_names = {
        1: "🔰 Новичок",
        2: "⛏️ Искатель",
        3: "⚔️ Воин",
    ...
    text = (
        f"📊 <b>{level_name}</b>, сука!\n\n"
        f"Уровень: {level}\n"
        f"Опыт: {exp} / {exp_needed}\n"
        f"{bar}\n\n"
        f"За повышение уровня ты получаешь баксы, репутацию и очки статов, гнида!\n"
...
async def reputation_handler(message: types.Message):
    ...
    await message.answer(
        f"⭐️ Твоя репутация: {rep}, пидор!\n\n"
        f"Репутация увеличивает шансы, сука:\n"
        f"🔫 Бонус к грабежу: +{theft_bonus:.1f}%\n"
        f"🛡 Бонус к защите: +{defense_bonus:.1f}%\n\n"
        f"Зарабатывай репутацию в играх и за выполнение заданий, бля!",
    ...
    try:
        ...
        if last_bonus_str:
            ...
            if now - last_bonus < timedelta(days=1):
                ...
                await message.answer(f"⏳ Бонус можно будет получить через {hours} ч {minutes} мин, лох.")
                return
        ...
        await message.answer("❌ Ошибка при получении бонуса, бля.")

# ==================== ТОП ИГРОКОВ (упрощённый) ====================
...
async def leaderboard_menu(message: types.Message):
    ...
    await message.answer("Выбери категорию топа, пидор:", reply_markup=kb)
...
async def show_top(message: types.Message, order_field: str, title: str):
    ...
    try:
        ...
        if not rows:
            await message.answer("Нет данных, сука.")
            return
        text = f"{title} (страница {page}), бля:\n\n"
        ...
        await message.answer("❌ Ошибка загрузки топа, гнида.")
...
async def shop_handler(message: types.Message):
    ...
    try:
        ...
        if not rows:
            await message.answer("🎁 В магазине пока нет подарков, лох.")
            return
        text = f"🎁 Подарки (страница {page}), сука:\n\n"
        kb = []
        for row in rows:
            item_id = row['id']
            name = row['name']
        ...
        await message.answer("❌ Ошибка загрузки магазина, бля.")
...
async def buy_callback(callback: types.CallbackQuery):
    ...
    ok, not_subscribed = await check_subscription(user_id)
    if not ok:
        await callback.message.edit_text("❗️ Сначала подпишись на каналы, сука.", reply_markup=subscription_inline(not_subscribed))
        return
    ...
    try:
        async with db_pool.acquire() as conn:
            ...
            if not row:
                await callback.answer("Товар не найден, бля.", show_alert=True)
                return
            name, price, stock, photo = row['name'], row['price'], row['stock'], row['photo_file_id']
            if stock != -1 and stock <= 0:
                await callback.answer("Товара нет в наличии, лох!", show_alert=True)
                return
            balance = await get_user_balance(user_id)
            if balance < price:
                await callback.answer(f"Не хватает баксов, гнида! У тебя {balance}, нужно {price}", show_alert=True)
                return
        ...
        try:
            await callback.message.edit_text(f"✅ Покупка совершена, сука!")
        except:
            pass
        ...
        await callback.answer("❌ Ошибка при покупке. Попробуй позже, бля.", show_alert=True)
...
async def notify_admins_about_purchase(user: types.User, item_name: str, price: int):
    ...
    for admin_id in admins:
        await safe_send_message(admin_id,
            f"🛒 Покупка, сука: пользователь {user.full_name} (@{user.username})\n"
            f"<a href=\"tg://user?id={user.id}\">Ссылка</a> купил {item_name} за {price} баксов, пидор!"
        )
...
async def my_purchases(message: types.Message):
    ...
    try:
        ...
        if not rows:
            await message.answer("У тебя пока нет покупок, лох.", reply_markup=user_main_keyboard(await is_admin(user_id)))
            return
        text = f"📦 Твои покупки (страница {page}), бля:\n"
        for row in rows:
        ...
        await message.answer("❌ Ошибка загрузки покупок, гнида.")
...
async def promo_handler(message: types.Message):
    ...
    if not ok:
        await message.answer("❗️ Сначала подпишись на каналы, сука.", reply_markup=subscription_inline(not_subscribed))
        return
    await message.answer("Введи промокод, пидор:", reply_markup=back_keyboard())
...
async def promo_activate(message: types.Message, state: FSMContext):
    ...
    try:
        async with db_pool.acquire() as conn:
            ...
            if already_used:
                await message.answer("❌ Ты уже активировал этот промокод, лох.")
                await state.finish()
                return
            row = await conn.fetchrow("SELECT reward, max_uses, used_count FROM promocodes WHERE code=$1", code)
            if not row:
                await message.answer("❌ Промокод не найден, гнида.")
                await state.finish()
                return
            reward, max_uses, used = row['reward'], row['max_uses'], row['used_count']
            if used >= max_uses:
                await message.answer("❌ Промокод уже использован максимальное количество раз, сука.")
                await state.finish()
                return
            async with conn.transaction():
        ...
        await message.answer(
            f"✅ Промокод активирован, пидор! Ты получил {reward} баксов.",
            reply_markup=user_main_keyboard(await is_admin(user_id))
        )
    except Exception as e:
        logging.error(f"Promo error: {e}")
        await message.answer("❌ Ошибка активации промокода, бля.")
    await state.finish()
...
async def perform_theft(message: types.Message, robber_id: int, victim_id: int, cost: int = 0):
    ...
    if robber_id == victim_id:
        await message.answer("Нельзя ограбить самого себя, идиот!")
        return
    # Запрет на атаку бота
    bot_user = await bot.me
    if victim_id == bot_user.id:
        await message.answer("Нельзя ограбить бота, лох!")
        return
    ...
    try:
        async with db_pool.acquire() as conn:
            async with conn.transaction():
                ...
                if robber_balance is None:
                    await message.answer("❌ Ошибка: ваш профиль не найден, сука.")
                    return
                ...
                if not victim_row:
                    await message.answer("❌ Цель не найдена в базе, бля.")
                    return
                ...
                if success and victim_balance > 0:
                    ...
                    if new_success == 15:
                        ...
                        if ref:
                            ...
                            await safe_send_message(referrer_id, f"🎉 Ваш реферал совершил 15 успешных ограблений, сука! Вы получили {bonus_coins} баксов и {bonus_rep} репутации.")
                    ...
                    await safe_send_message(victim_id, f"🔫 Вас ограбили, лох! {message.from_user.first_name} украл {steal_amount} баксов.")
                else:
                    await conn.execute("UPDATE users SET theft_attempts = theft_attempts + 1, theft_failed = theft_failed + 1 WHERE user_id=$1", robber_id)
                    exp_fail = int(await get_setting("exp_per_theft_fail"))
                    await add_exp(robber_id, exp_fail, conn=conn)
        ...
        await message.answer("❌ Ошибка при ограблении, бля.")
...
async def theft_random(message: types.Message, state: FSMContext):
    ...
    if not target_id:
        await message.answer("😕 В игре пока нет других игроков, лох.", reply_markup=user_main_keyboard(await is_admin(user_id)))
        return
    ...
    async with db_pool.acquire() as conn:
        ...
        if last_time_str:
            ...
            if diff < timedelta(minutes=cooldown_minutes):
                ...
                await message.answer(phrase, reply_markup=user_main_keyboard(await is_admin(user_id)))
                return
    await message.answer("Введи @username или ID того, кого хочешь ограбить, пидор:", reply_markup=back_keyboard())
...
async def theft_target_entered(message: types.Message, state: FSMContext):
    ...
    if not target_data:
        await message.answer("❌ Пользователь не найден. Проверь username или ID, лох.")
        return
    target_id = target_data['user_id']

    if target_id == robber_id:
        await message.answer("Сам себя не ограбишь, идиот!")
        await state.finish()
        return

    if await is_banned(target_id):
        await message.answer("❌ Этот пользователь заблокирован и не может быть целью, сука.")
        await state.finish()
        return
...
async def referral_link(message: types.Message):
    ...
    await message.answer(
        f"🔗 Твоя реферальная ссылка, сука:\n{link}\n\n"
        f"📊 Статистика, пидор:\n"
        f"• Переходов: {clicks}\n"
        f"• Активных рефералов: {active}\n"
        f"• Заработано баксов: {earned}\n\n"
        f"Бонус: {bonus_coins} баксов и {bonus_rep} репутации за каждого активного реферала (15 успешных краж), гнида."
    )
...
async def tasks_menu(message: types.Message):
    ...
    if not rows:
        await message.answer("📋 Пока нет доступных заданий, лох.", reply_markup=user_main_keyboard(await is_admin(user_id)))
        return

    text = "📋 Доступные задания, сука:\n\n"
    kb = []
    for row in rows:
...
async def take_task(callback: types.CallbackQuery):
    ...
    async with db_pool.acquire() as conn:
        ...
        if existing:
            await callback.answer("Ты уже выполнял это задание, лох!", show_alert=True)
            return

        task = await conn.fetchrow("SELECT * FROM tasks WHERE id=$1 AND active=TRUE", task_id)
        if not task:
            await callback.answer("Задание не найдено или неактивно, сука.", show_alert=True)
            return

        if task['max_completions'] > 0 and task['completed_count'] >= task['max_completions']:
            await callback.answer("Это задание больше недоступно (лимит выполнений исчерпан), гнида.", show_alert=True)
            return
        ...
        if task['task_type'] == 'subscribe':
            ...
            try:
                ...
                if member.status in ['left', 'kicked']:
                    await callback.answer("❌ Ты не подписан на этот канал, пидор!", show_alert=True)
                    return
            except Exception as e:
                logging.error(f"Task subscribe check error: {e}")
                await callback.answer("❌ Не удалось проверить подписку. Возможно, бот не админ канала, бля.", show_alert=True)
                return
            ...
            await callback.answer(f"✅ Задание выполнено, сука! +{task['reward_coins']} баксов, +{task['reward_reputation']} репутации", show_alert=True)
            await callback.message.delete()
        else:
            await callback.answer("Этот тип заданий пока не поддерживается, бля.", show_alert=True)
...
async def list_auctions(message: types.Message, page: int = 1):
    ...
    if not rows:
        await message.answer("🏷 На данный момент нет активных аукционов, лох.", reply_markup=user_main_keyboard(await is_admin(message.from_user.id)))
        return
    text = f"🏷 Активные аукционы (страница {page}), сука:\n\n"
    for row in rows:
...
async def auction_view(callback: types.CallbackQuery):
    ...
    async with db_pool.acquire() as conn:
        ...
        if not auction:
            await callback.answer("Аукцион не найден или завершён, сука.", show_alert=True)
            return
...
async def auction_bid_start(callback: types.CallbackQuery, state: FSMContext):
    ...
    await callback.message.answer("Введи сумму ставки (целое число), пидор:", reply_markup=back_keyboard())
...
async def auction_bid_amount(message: types.Message, state: FSMContext):
    ...
    try:
        ...
        await message.answer("❌ Введи положительное целое число, лох.")
        return
    ...
    async with db_pool.acquire() as conn:
        auction = await conn.fetchrow("SELECT * FROM auctions WHERE id=$1 AND status='active'", auction_id)
        if not auction:
            await message.answer("❌ Аукцион не найден или завершён, сука.")
            await state.finish()
            return
        min_step = int(await get_setting("auction_min_bid_step"))
        min_bid = auction['current_price'] + min_step
        if amount < min_bid:
            await message.answer(f"❌ Ставка должна быть не меньше {min_bid} (текущая цена + минимальный шаг), гнида.")
            return
        balance = await get_user_balance(user_id)
        if balance < amount:
            await message.answer("❌ Недостаточно баксов, пидор.")
            return
        ...
        if auction['target_price'] and amount >= auction['target_price']:
            ...
            await safe_send_message(auction['created_by'], f"🏁 Аукцион «{auction['item_name']}» завершён по достижению целевой цены, бля. Победитель: {message.from_user.first_name} (ID: {user_id}) с суммой {amount} баксов.")
...
async def auction_list_back(callback: types.CallbackQuery):
    ...
    await callback.answer()
# ==================== ПОЛНЫЙ РАБОЧИЙ БОТ ====================
# Часть 4: Групповые хендлеры и функции боссов

# ==================== ГРУППОВЫЕ ЧАТЫ ====================
async def check_chat(message: types.Message) -> bool:
    if message.chat.type == 'private':
        await auto_delete_reply(message, "❌ Эта команда работает только в группах, сука.")
        return False
    if not await is_chat_confirmed(message.chat.id):
        await auto_delete_reply(message, "❌ Этот чат не активирован, пидор. Обратитесь к администратору.")
        return False
    return True
...
async def cmd_fight(message: types.Message):
    ...
    if not ok:
        await auto_delete_reply(
            message,
            f"⏳ Ты слишком часто машешь кулаками, лох! Подожди ещё {format_time_remaining(remaining * 60)}."
        )
        return
    ...
    await auto_delete_reply(
        message,
        f"{username}, {phrase}\n"
        f"Твой авторитет в этом чате, сука: {await get_chat_authority(chat_id, user_id)}"
    )

    if outcome == "counter":
        await auto_delete_reply(message, f"💸 Ты потерял {counter_damage} баксов, гнида.")
...
async def cmd_gym(message: types.Message):
    ...
    await auto_delete_reply(
        message,
        f"🏋️ Качалка, пидор! У тебя {authority} авторитета.\n"
...
async def gym_callback(callback: types.CallbackQuery):
    ...
    if not await is_chat_confirmed(chat_id):
        await callback.answer("Чат не активирован, сука.", show_alert=True)
        return
    ...
    if action == "strength":
        ...
        await callback.answer("Неизвестная опция, бля.")
        return

    authority = await get_chat_authority(chat_id, user_id)
    if authority < cost:
        await callback.answer(f"❌ Не хватает авторитета, лох. Нужно {cost}, у тебя {authority}.", show_alert=True)
        return
    ...
    if await spend_chat_authority(chat_id, user_id, cost):
        ...
        await callback.answer(f"✅ Ты улучшил {stat}, сука!", show_alert=True)
        await callback.message.edit_text(
            f"✅ Ты улучшил {stat}, пидор!\n"
            f"Осталось авторитета: {await get_chat_authority(chat_id, user_id)}"
        )
    else:
        await callback.answer("❌ Ошибка при списании авторитета, гнида.", show_alert=True)
...
async def cmd_status(message: types.Message):
    ...
    text = (
        f"📊 Твой статус в этом чате, сука:\n"
...
async def show_chat_top(chat_id: int, message: types.Message, page: int = 1, order: str = "authority"):
    ...
    if not rows:
        await auto_delete_reply(message, "🏆 В этом чате пока нет участников, лохи.")
        return

    text = f"🏆 Топ чата (по {order}), пидоры:\n"
...
async def cmd_help_chat(message: types.Message):
    ...
    await auto_delete_message(message)
    text = (
        "📚 Доступные команды в этом чате, суки:\n"
...
async def chat_gift(message: types.Message):
    ...
    if await is_banned(user_id):
        return
    if not await is_chat_confirmed(chat_id):
        await auto_delete_reply(message, "❌ Этот чат ещё не активирован, пидор. Ожидайте подтверждения администратора.")
        return
    ...
    async with db_pool.acquire() as conn:
        async with conn.transaction():
            ...
            if gift_count_today >= gift_limit_per_chat:
                await auto_delete_reply(message, f"❌ Сегодня в этом чате уже использовано {gift_count_today} из {gift_limit_per_chat} подгонов, лохи.")
                return
            ...
            if user_gift_count >= gift_global_limit:
                await auto_delete_reply(message, f"❌ Сегодня ты уже получил {user_gift_count} из {gift_global_limit} подгонов во всех чатах, гнида.")
                return
            ...
            if user['last_gift_time']:
                ...
                if diff < gift_cooldown:
                    ...
                    await auto_delete_reply(message, f"⏳ Подгон можно будет использовать через {remaining} мин, сука.")
                    return
            ...
            try:
                ...
                if not eligible:
                    await auto_delete_reply(message, "❌ Нет подходящих получателей для подарка, пидоры.")
                    return
                recipient = random.choice(eligible)
            except Exception as e:
                logging.error(f"Gift error: {e}")
                await auto_delete_reply(message, "❌ Не удалось выбрать получателя, бля.")
                return
            ...
            await message.reply(
                f"🎁 {message.from_user.first_name} активировал подгон, сука!\n"
                f"Счастливчик: {recipient.first_name} получает {gift_amount} баксов, пидор! 🎉\n"
...
async def bot_added_to_chat(message: types.Message):
    ...
    for admin_id in SUPER_ADMINS:
        ...
        text = (
            f"🆕 Запрос на активацию бота в чате, сука:\n"
    ...
    await message.answer("📋 Запрос на активацию бота отправлен администратору, пидор. Ожидайте подтверждения.")
...
async def unknown_command(message: types.Message):
    ...
    if not await is_chat_confirmed(message.chat.id):
        return
    await auto_delete_reply(message, "❌ Неизвестная команда, лох. Введи /help для списка доступных.")
# ==================== ПОЛНЫЙ РАБОЧИЙ БОТ ====================
# Часть 5: Административные хендлеры (управление пользователями, магазином, боссами, аукционами, админами и т.д.)
...
async def admin_panel(message: types.Message):
    ...
    if not await is_admin(message.from_user.id):
        await message.answer("У тебя нет прав администратора, пидор.")
        return
    permissions = await get_admin_permissions(message.from_user.id)
    await message.answer("Панель администратора, сука:", reply_markup=admin_main_keyboard(permissions))
...
async def admin_users_menu(message: types.Message):
    if not await has_permission(message.from_user.id, "manage_users"):
        await message.answer("❌ У тебя нет прав на управление пользователями, гнида.")
        return
    await message.answer("Управление пользователями, сука:", reply_markup=admin_users_keyboard())

@dp.message_handler(lambda message: message.text == "💰 Начислить баксы")
async def add_balance_start(message: types.Message):
    if not await has_permission(message.from_user.id, "manage_users"):
        await message.answer("❌ Недостаточно прав, пидор.")
        return
    await message.answer("Введи ID или @username пользователя, сука:", reply_markup=back_keyboard())
...
async def add_balance_user(message: types.Message, state: FSMContext):
    ...
    if not user_data:
        await message.answer("❌ Пользователь не найден, лох.")
        return
    uid = user_data['user_id']
    await state.update_data(user_id=uid)
    await message.answer("Введи сумму начисления (целое положительное число), сука:")
...
async def add_balance_amount(message: types.Message, state: FSMContext):
    ...
    try:
        ...
        await message.answer("❌ Введи положительное целое число, гнида.")
        return
    data = await state.get_data()
    uid = data['user_id']
    try:
        await update_user_balance(uid, amount)
        await message.answer(f"✅ Пользователю {uid} начислено {amount} баксов, сука.")
        await safe_send_message(uid, f"💰 Вам начислено {amount} баксов администратором, пидор.")
    except Exception as e:
        logging.error(f"Add balance error: {e}")
        await message.answer("❌ Ошибка, бля.")
    await state.finish()
...
async def remove_balance_user(message: types.Message, state: FSMContext):
    ...
    uid = user_data['user_id']
    await state.update_data(user_id=uid)
    await message.answer("Введи сумму списания (целое положительное число), гнида:")
...
async def remove_balance_amount(message: types.Message, state: FSMContext):
    ...
    try:
        ...
        await message.answer("❌ Введи положительное целое число, пидор.")
        return
    data = await state.get_data()
    uid = data['user_id']
    try:
        await update_user_balance(uid, -amount)
        await message.answer(f"✅ У пользователя {uid} списано {amount} баксов, сука.")
        await safe_send_message(uid, f"💸 У тебя списано {amount} баксов администратором, лох.")
    except Exception as e:
...
async def add_reputation_user(message: types.Message, state: FSMContext):
    ...
    uid = user_data['user_id']
    await state.update_data(user_id=uid)
    await message.answer("Введи количество репутации для начисления (целое число), гнида:")
...
async def add_reputation_amount(message: types.Message, state: FSMContext):
    ...
    try:
        ...
        await message.answer("❌ Введи целое число, пидор.")
        return
    data = await state.get_data()
    uid = data['user_id']
    try:
        await update_user_reputation(uid, amount)
        await message.answer(f"✅ Пользователю {uid} начислено {amount} репутации, сука.")
        await safe_send_message(uid, f"⭐️ Вам начислено {amount} репутации администратором, пидор.")
    except Exception as e:
...
async def remove_reputation_user(message: types.Message, state: FSMContext):
    ...
    uid = user_data['user_id']
    await state.update_data(user_id=uid)
    await message.answer("Введи количество репутации для снятия (целое число), гнида:")
...
async def remove_reputation_amount(message: types.Message, state: FSMContext):
    ...
    try:
        await update_user_reputation(uid, -amount)
        await message.answer(f"✅ У пользователя {uid} снято {amount} репутации, сука.")
        await safe_send_message(uid, f"🔻 У вас снято {amount} репутации администратором, лох.")
    except Exception as e:
...
async def add_exp_user(message: types.Message, state: FSMContext):
    ...
    uid = user_data['user_id']
    await state.update_data(user_id=uid)
    await message.answer("Введи количество опыта для начисления (целое число), гнида:")
...
async def add_exp_amount(message: types.Message, state: FSMContext):
    ...
    try:
        ...
        await message.answer(f"✅ Пользователю {uid} начислено {amount} опыта, сука.")
    except Exception as e:
...
async def set_level_user(message: types.Message, state: FSMContext):
    ...
    uid = user_data['user_id']
    await state.update_data(user_id=uid)
    await message.answer("Введи новый уровень (целое число ≥ 1), гнида:")
...
async def set_level_value(message: types.Message, state: FSMContext):
    ...
    try:
        ...
        await message.answer("❌ Введи целое число ≥ 1, пидор.")
        return
    data = await state.get_data()
    uid = data['user_id']
    try:
        ...
        await message.answer(f"✅ Пользователю {uid} установлен уровень {level}, сука.")
        await safe_send_message(uid, f"🔝 Ваш уровень изменён на {level} администратором, пидор.")
    except Exception as e:
...
async def export_users(message: types.Message):
    ...
    try:
        ...
        if not csv_data:
            await message.answer("Нет пользователей для экспорта, сука.")
            return
        await message.answer_document(
            types.InputFile(io.BytesIO(csv_data), filename="users.csv"),
            caption="📊 Список пользователей, гнида"
        )
    except Exception as e:
        logging.error(f"Export error: {e}")
        await message.answer("❌ Ошибка при экспорте, бля.")
...
async def admin_shop_menu(message: types.Message):
    if not await has_permission(message.from_user.id, "manage_shop"):
        await message.answer("❌ Недостаточно прав, пидор.")
        return
    await message.answer("Управление магазином, сука:", reply_markup=admin_shop_keyboard())
...
async def add_shop_item_start(message: types.Message):
    if not await has_permission(message.from_user.id, "manage_shop"):
        await message.answer("❌ Недостаточно прав, пидор.")
        return
    await message.answer("Введи название товара, сука:", reply_markup=back_keyboard())
...
async def add_shop_item_name(message: types.Message, state: FSMContext):
    ...
    await message.answer("Введи описание товара, гнида:")
...
async def add_shop_item_description(message: types.Message, state: FSMContext):
    ...
    await message.answer("Введи цену (целое число), пидор:")
    await AddShopItem.next()
...
async def add_shop_item_price(message: types.Message, state: FSMContext):
    ...
    try:
        ...
        await message.answer("❌ Цена должна быть положительным целым числом, сука.")
        return
    await state.update_data(price=price)
    await message.answer("Введи количество товара (целое число, -1 для бесконечного), гнида:")
...
async def add_shop_item_photo(message: types.Message, state: FSMContext):
    ...
    if message.photo:
        ...
        await message.answer("Отправь фото или 'нет', сука.")
        return
    data = await state.get_data()
    try:
        async with db_pool.acquire() as conn:
        ...
        await message.answer("✅ Товар добавлен, пидор!", reply_markup=admin_shop_keyboard())
    except Exception as e:
        logging.error(f"Add shop item error: {e}")
        await message.answer("❌ Ошибка при добавлении товара, бля.")
    await state.finish()
...
async def remove_shop_item_start(message: types.Message):
    ...
    try:
        ...
        if not items:
            await message.answer("В магазине нет товаров, сука.")
            return
        text = "Товары, гнида:\n" + "\n".join([f"ID {i['id']}: {i['name']}" for i in items])
        await message.answer(text + "\n\nВведи ID товара для удаления, пидор:", reply_markup=back_keyboard())
    except Exception as e:
...
async def remove_shop_item(message: types.Message, state: FSMContext):
    ...
    try:
        ...
        await message.answer("❌ Введи число, лох.")
        return
    try:
        async with db_pool.acquire() as conn:
            await conn.execute("DELETE FROM shop_items WHERE id=$1", item_id)
        await message.answer("✅ Товар удалён, если существовал, сука.", reply_markup=admin_shop_keyboard())
    except Exception as e:
...
async def list_shop_items(message: types.Message):
    ...
    try:
        ...
        if not items:
            await message.answer("В магазине нет товаров, сука.")
            return
        text = f"📦 Товары (страница {page}), гнида:\n"
        for item in items:
...
async def edit_shop_item_start(message: types.Message):
    if not await has_permission(message.from_user.id, "manage_shop"):
        await message.answer("❌ Недостаточно прав, пидор.")
        return
    await message.answer("Введи ID товара для редактирования, сука:", reply_markup=back_keyboard())
...
async def edit_shop_item_field(message: types.Message, state: FSMContext):
    ...
    await message.answer("Что хочешь изменить? (price/stock), гнида:", reply_markup=back_keyboard())
...
async def edit_shop_item_value(message: types.Message, state: FSMContext):
    ...
    if field not in ['price', 'stock']:
        await message.answer("❌ Можно изменить только price или stock, пидор.")
        return
    await state.update_data(field=field)
    await message.answer(f"Введи новое значение для {field}, сука:")
...
async def edit_shop_item_final(message: types.Message, state: FSMContext):
    ...
    try:
        ...
        await message.answer("❌ Введи целое число, гнида.")
        return
    data = await state.get_data()
    ...
    try:
        ...
        await message.answer("✅ Товар обновлён, пидор.", reply_markup=admin_shop_keyboard())
    except Exception as e:
...
async def admin_purchases(message: types.Message):
    ...
    try:
        ...
        if not rows:
            await message.answer("Нет необработанных покупок, сука.")
            return
        for row in rows:
        ...
        await message.answer("❌ Ошибка загрузки покупок, бля.")
...
async def purchase_done(callback: types.CallbackQuery):
    if not await has_permission(callback.from_user.id, "manage_shop"):
        await callback.answer("Недостаточно прав, пидор", show_alert=True)
        return
    ...
    try:
        async with db_pool.acquire() as conn:
            ...
            if user_id:
                await safe_send_message(user_id, "✅ Твоя покупка обработана, сука! Админ выслал подарок.")
        await callback.answer("Покупка отмечена как выполненная, гнида")
        await callback.message.delete()
    except Exception as e:
...
async def purchase_reject(callback: types.CallbackQuery):
    ...
    try:
        async with db_pool.acquire() as conn:
            ...
            user_id = await conn.fetchval("SELECT user_id FROM purchases WHERE id=$1", purchase_id)
            if user_id:
                await safe_send_message(user_id, "❌ К сожалению, твоя покупка не может быть выполнена, лох. Свяжись с админом.")
        await callback.answer("Покупка отклонена, сука")
        await callback.message.delete()
    except Exception as e:
...
async def admin_giveaway_menu(message: types.Message):
    if not await has_permission(message.from_user.id, "manage_giveaways"):
        await message.answer("❌ Недостаточно прав, пидор.")
        return
    await message.answer("Управление розыгрышами, сука:", reply_markup=admin_giveaway_keyboard())
...
async def admin_channel_menu(message: types.Message):
    if not await has_permission(message.from_user.id, "manage_channels"):
        await message.answer("❌ Недостаточно прав, пидор.")
        return
    await message.answer("Управление каналами, сука:", reply_markup=admin_channel_keyboard())
...
async def admin_promo_menu(message: types.Message):
    if not await has_permission(message.from_user.id, "manage_promocodes"):
        await message.answer("❌ Недостаточно прав, пидор.")
        return
    await message.answer("Управление промокодами, сука:", reply_markup=admin_promo_keyboard())
...
async def admin_tasks_menu(message: types.Message):
    if not await has_permission(message.from_user.id, "manage_tasks"):
        await message.answer("❌ Недостаточно прав, пидор.")
        return
    await message.answer("Управление заданиями, сука:", reply_markup=admin_tasks_keyboard())
...
async def admin_chats_menu(message: types.Message):
    if not await has_permission(message.from_user.id, "manage_chats"):
        await message.answer("❌ Недостаточно прав, пидор.")
        return
    await message.answer("Управление чатами, сука:", reply_markup=admin_chats_keyboard())
...
async def admin_boss_menu(message: types.Message):
    if not await has_permission(message.from_user.id, "manage_bosses"):
        await message.answer("❌ Недостаточно прав, пидор.")
        return
    await message.answer("Управление боссами, сука:", reply_markup=admin_boss_keyboard())
...
async def list_active_bosses(message: types.Message):
    ...
    if not rows:
        await message.answer("Нет активных боссов, сука.")
        return
    text = "Активные боссы, гнида:\n"
    for row in rows:
...
async def manual_spawn_boss_start(message: types.Message):
    if not await has_permission(message.from_user.id, "manage_bosses"):
        return
    await message.answer("Введи ID чата, где создать босса, пидор:", reply_markup=back_keyboard())
...
async def manual_spawn_boss_chat(message: types.Message, state: FSMContext):
    ...
    try:
        ...
        return
    if not await is_chat_confirmed(chat_id):
        await message.answer("❌ Чат не подтверждён, сука. Сначала подтвердите его.")
        await state.finish()
        return
    await state.update_data(chat_id=chat_id)
    await message.answer("Введи уровень босса (1-10), гнида:")
...
async def manual_spawn_boss_level(message: types.Message, state: FSMContext):
    ...
    try:
        ...
        await message.answer("❌ Введи число от 1 до 10, пидор.")
        return
    await state.update_data(level=level)
    await message.answer("Отправь фото для босса (или 'нет'):")
...
async def manual_spawn_boss_image(message: types.Message, state: FSMContext):
    ...
    await message.answer(f"✅ Босс {level} уровня создан в чате {chat_id}, пидор.")
    await state.finish()
...
async def admin_auction_menu(message: types.Message):
    if not await has_permission(message.from_user.id, "manage_auctions"):
        await message.answer("❌ Недостаточно прав, пидор.")
        return
    await message.answer("Управление аукционами, сука:", reply_markup=admin_auction_keyboard())

@dp.message_handler(lambda message: message.text == "➕ Создать аукцион")
async def create_auction_start(message: types.Message):
    if not await has_permission(message.from_user.id, "manage_auctions"):
        return
    await message.answer("Введи название товара, пидор:", reply_markup=back_keyboard())
...
async def create_auction_name(message: types.Message, state: FSMContext):
    ...
    await message.answer("Введи описание товара, сука:")
...
async def create_auction_description(message: types.Message, state: FSMContext):
    if message.text == "◀️ Назад":
        ...
        return
    await state.update_data(description=message.text)
    await message.answer("Введи стартовую цену (целое число), гнида:")
    await CreateAuction.next()
...
async def create_auction_start_price(message: types.Message, state: FSMContext):
    ...
    await message.answer("Введи время окончания в часах (целое число) или 'нет', если не нужно, сука:")
    await CreateAuction.next()
...
async def create_auction_end_time(message: types.Message, state: FSMContext):
    ...
    if message.text.lower() == 'нет':
        ...
        try:
            ...
            await message.answer("❌ Введи целое положительное число часов или 'нет', лох.")
            return
    await state.update_data(end_time=end_time)
    await message.answer("Введи целевую цену (целое число) или 'нет', если не нужна, гнида:")
    await CreateAuction.next()
...
async def create_auction_photo(message: types.Message, state: FSMContext):
    ...
    try:
        ...
        await message.answer("❌ Ошибка при создании аукциона, бля.")
    await state.finish()
...
async def list_active_auctions(message: types.Message):
    ...
    if not rows:
        await message.answer("Нет активных аукционов, сука.")
        return
    text = "Активные аукционы, гнида:\n"
    for row in rows:
...
async def cancel_auction_start(message: types.Message):
    if not await has_permission(message.from_user.id, "manage_auctions"):
        return
    await message.answer("Введи ID аукциона для отмены, пидор:", reply_markup=back_keyboard())
...
async def admin_ad_menu(message: types.Message):
    if not await has_permission(message.from_user.id, "manage_ads"):
        ...
        return
    await message.answer("Управление рекламой, сука:", reply_markup=admin_ad_keyboard())
...
async def admin_admins_menu(message: types.Message):
    if not await has_permission(message.from_user.id, "manage_admins"):
        ...
        return
    await message.answer("Управление админами, сука:", reply_markup=admin_admins_keyboard())

@dp.message_handler(lambda message: message.text == "➕ Добавить админа")
async def add_admin_start(message: types.Message):
    if not await has_permission(message.from_user.id, "manage_admins"):
        return
    await message.answer("Введи ID или @username пользователя, которого хочешь сделать младшим админом, пидор:", reply_markup=back_keyboard())
...
async def add_admin_finish(message: types.Message, state: FSMContext):
    ...
    await message.answer("Выбери права для нового админа (можно несколько), сука:", reply_markup=kb)
...
async def add_admin_toggle_perm(callback: types.CallbackQuery, state: FSMContext):
    ...
    if perm in selected:
        ...
        await callback.answer(f"✅ Право {perm} добавлено, сука")
...
async def add_admin_done(callback: types.CallbackQuery, state: FSMContext):
    ...
    try:
        ...
        await callback.message.edit_text("❌ Ошибка при добавлении админа, бля.")
    await state.finish()
...
async def edit_admin_permissions_start(message: types.Message):
    if not await has_permission(message.from_user.id, "manage_admins"):
        return
    await message.answer("Введи ID или @username админа, чьи права хочешь изменить, сука:", reply_markup=back_keyboard())
...
async def edit_admin_permissions_user(message: types.Message, state: FSMContext):
    ...
    await message.answer("Выбери права (нажимай для переключения), сука:", reply_markup=kb)
...
async def remove_admin_start(message: types.Message):
    if not await has_permission(message.from_user.id, "manage_admins"):
        return
    await message.answer("Введи ID или @username админа, которого хочешь удалить, сука:", reply_markup=back_keyboard())
...
async def list_admins(message: types.Message):
    ...
    await message.answer(text)
# ==================== ПОЛНЫЙ РАБОЧИЙ БОТ ====================
# Часть 6: Административные хендлеры (продолжение), фоновые задачи, точка входа

# ==================== УПРАВЛЕНИЕ АУКЦИОНАМИ (продолжение) ====================
@dp.message_handler(lambda message: message.text == "🏷 Аукцион")
async def admin_auction_menu(message: types.Message):
    if not await has_permission(message.from_user.id, "manage_auctions"):
        await message.answer("❌ Недостаточно прав.")
...
async def edit_ad_start(message: types.Message):
    ...
    # Можно добавить FSM для редактирования, но для краткости пропустим.
...
async def set_setting_key(message: types.Message, state: FSMContext):
    ...
    if key not in DEFAULT_SETTINGS:
        await message.answer("❌ Неизвестный параметр. Попробуй ещё раз или /cancel.")
        return
...
# Аналогичные хендлеры для других категорий (казино, опыт, боссы и т.д.) можно добавить по такому же принципу.
